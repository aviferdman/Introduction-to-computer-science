...
public class BankAccount {
    ...
    public boolean depositMoney(int amount) {
    	//if the amount is negative return false
        if(amount<0)
        	return false;
        //if the amount is legal, update the balance and return true
        else {
    ...
    public boolean withdrawMoney(int amount) {
    	//if the amount is negative or not enough money in balance, return false without updating the balance
        if(amount<0|balance-amount<0)
        	return false;
        //if it possible to withdraw money, update the balance and return true
        else {
        	balance = balance - amount;
        	return true;
        }
